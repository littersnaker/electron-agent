...
const PROMPT_REGISTRY: Record<PromptId, PromptDefinition> = {
  "final_answer": {
    id: "final_answer",
    version: "1.0.0",
    description: "systemPromptText",
    template: `你是一个高级代码任务总结助手。
...
`,
  ...
  "high_level_planner": {
    ...
    version: "1.0.0",
    description: "HighLevelPlannerPromptText",
    template: `
...
`,
  ...
  "worker_memory": {
    id: "worker_memory",
    version: "1.0.0",
    description: "WorkerMemoryPromptText",
    template: `
...
`,
  ...
  "reviewer": {
    id: "reviewer",
    version: "1.0.0",
    description: "ReviewerPromptText",
    template: `
...
`,
  ...
  "modify_worker": {
    id: "modify_worker",
    version: "1.0.0",
    description: "ModifyWorkerPromptText",
    template: `
你是独立 Modify Worker。只负责当前 Send 分配的任务，持续调用工具直到形成可交给 Merge Patch Manager 的完整文件提案。
...
`,
  ...
  "final_report_agent": {
    ...
    version: "1.0.0",
    description: "FinalReportAgentPromptText",
    template: `
...
/**
 * 获取不可变 Prompt 定义。后续可以在这里接入远端 Prompt Hub 或版本灰度，
 * 调用方无需改变。
 */
...
/** 支持简单 {{variable}} 替换，未提供的变量保持原占位符。 */
export function renderPrompt(
  id: PromptId,
  variables: Readonly<Record<string, string>> = {},
): string {
  const template = getPromptDefinition(id).template;
